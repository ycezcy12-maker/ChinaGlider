...
export const seasonColors = {
  spring: { bg: "rgba(134, 179, 140, 0.12)", accent: "#5D9B6B", text: "#3a6e42" },
  summer: { bg: "rgba(219, 180, 105, 0.12)", accent: "#C8923A", text: "#7a5520" },
  autumn: { bg: "rgba(192, 108, 84, 0.12)", accent: "#C06C54", text: "#8B3E28" },
  winter: { bg: "rgba(139, 156, 192, 0.12)", accent: "#6B82A8", text: "#3d567a" }
};
